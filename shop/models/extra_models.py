...
#                     raise e
#             time.sleep(0.1)
#         User.objects(telegram_id__in=blocked_ids).update(is_block=True)
...
#
# t = f'Новогодние скидки'
# b = f'Спешим обрадовать всех наших клиентов нвогодними скидками на следующие товарыЖ:'
#
# news = News(title=t, body=b).save()


# news = News.objects()
#
# for i in news:
#     print(getattr(i, 'title'), getattr(i, 'created'))